...
BURIQ () {
    curl -sS  https://raw.githubusercontent.com/KdevN91/ipvps/main/ipvps > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/KdevN91/ipvps/main/ipvps | grep $MYIP | awk '{print $2}')
...
wget -q -O /usr/local/bin/websocket https://raw.githubusercontent.com/KDevN9/scvps/main/websocket/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/KDevN9/scvps/main/websocket/ws-ovpn.py
