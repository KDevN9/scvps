...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/KDevN9/scvps/main/add/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/KDevN9/scvps/main/del/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/KDevN9/scvps/main/renew/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
