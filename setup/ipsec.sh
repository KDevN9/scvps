...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/KDevN9/scvps/main/add/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/KDevN9/scvps/main/del/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/KDevN9/scvps/main/add/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/KDevN9/scvps/main/del/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/KDevN9/scvps/main/renew/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/KDevN9/scvps/main/renew/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
